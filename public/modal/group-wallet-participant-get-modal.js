...
const modalName = "group-wallet-participant-get";

class GroupWalletParticipantGetModal extends HTMLElement {
    connectedCallback() {
        //이미 생성돼 있어야하는 DOM
...
customElements.define(`${modalName}-modal`, GroupWalletParticipantGetModal);