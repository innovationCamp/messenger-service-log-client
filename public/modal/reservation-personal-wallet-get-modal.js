...
const modalName = "reservation-personal-wallet-get";

class ReservationPersonalWalletGetModal extends HTMLElement {
    connectedCallback() {
        //이미 생성돼 있어야하는 DOM
...
customElements.define(`${modalName}-modal`, ReservationPersonalWalletGetModal);