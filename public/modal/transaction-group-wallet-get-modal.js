...
const modalName = "transaction-group-wallet-get";

class TransactionGroupWalletGetModal extends HTMLElement {
    connectedCallback() {
        //이미 생성돼 있어야하는 DOM
...
customElements.define(`${modalName}-modal`, TransactionGroupWalletGetModal);